...
1. Understand and explain the use of Middleware.
  // Middleware functions can perform : execute any code. make changes to the request and the respose objects.end the response cycle.
1. The basic principles of the REST architectural style.
   //
1. Understand and explain the use of Express Routers.
  // express Router used to create a new router.
